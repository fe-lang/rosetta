...
import "../src/v6/PlonkVerifier.sol";
...
/// @title Plonk v6 gas comparison: Fe vs gnark-generated Solidity (100% assembly)
contract PlonkCompareTest {
    address private constant HEVM_ADDRESS = address(uint160(uint256(keccak256("hevm cheat code"))));
    Vm private constant vm = Vm(HEVM_ADDRESS);

    PlonkVerifier private solVerifier;
    address private feAddr;

    // SP1 v6 public inputs
    ...
    // Raw proof bytes for the gnark Solidity verifier (gnark MarshalSolidity format)
    bytes internal constant GNARK_PROOF = hex"06232459bd070942b95a2fd99cf8872eeee49ba7cd7ebe07ec3ef1b4b2a74d91"
    ...
    function setUp() public {
        ...
        // Deploy Solidity PlonkVerifier
        solVerifier = new PlonkVerifier();

        // Deploy Fe PlonkBench
    ...
    /// @notice Gas: gnark Solidity PlonkVerifier (100% assembly)
    function testGas_sol_plonkVerify() public view {
        ...
        inputs[3] = PI3;
        inputs[4] = PI4;
        solVerifier.Verify(GNARK_PROOF, inputs);
    }

    /// @notice Gas: Fe PlonkVerifier (readable code)
    function testGas_fe_plonkVerify() public view {
        ...
        require(success, "Fe call reverted");
        require(abi.decode(result, (bool)), "Fe verification failed");
    }
}
